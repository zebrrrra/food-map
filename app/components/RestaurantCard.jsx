...
const RestaurantCard = ({ id, data }) => {
  ...
  return (
    <Link
      ...
      className="block max-w-[300px] md:h-[150px] md:max-w-full "
    >
      <li
        className="flex h-full snap-start rounded-xl bg-white px-4 pt-4 shadow-lg  md:cursor-pointer md:flex-row md:overflow-hidden md:px-2 md:pb-2 "
        id={id}
      ...
      >
        ...
        <div className="w-[calc(100%-102px)] pl-4 md:w-[calc(100%-104px)] md:flex-1 md:pl-2 lg:w-[calc(100%-164px)]">
          ...
          <button className="mt-2 h-10 w-full rounded-md bg-brand-700 text-white md:hidden">
